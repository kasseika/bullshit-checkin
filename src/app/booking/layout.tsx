...
export default function BookingLayout({
  ...
  // トップページでは「最初に戻る」ボタンを表示しない
  const isTopPage = pathname === "/booking";
  ...
  }, [isTopPage, resetInactivityTimer]);
  ...
  }, [isTopPage, lastActivity, router, resetInactivityTimer, warningShown]);

  return (
    <div className="relative min-h-screen">
      {children}
      
      {/* 「最初に戻る」ボタン - トップページ以外で表示 */}
      {!isTopPage && (
