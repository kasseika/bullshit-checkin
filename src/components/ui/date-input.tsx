...
const DateInput: React.FC<DateInputProps> = ({ value, onChange }) => {
  ...
  return (
    <div className="flex border rounded items-center text-xs px-1 h-7">
      <input
        type="text"
        ref={monthRef}
        max={12}
        ...
        className="p-0 outline-none w-5 border-none text-center text-xs"
        placeholder="M"
      />
      ...
      <input
        ...
        className="p-0 outline-none w-10 border-none text-center text-xs"
        placeholder="YYYY"
      />
    </div>
  )
