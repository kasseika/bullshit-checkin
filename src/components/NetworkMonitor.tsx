...
export function NetworkMonitor() {
  ...
  }, [isOnline, isBookingPath]);

  useEffect(() => {
    // bookingパスまたはクライアントサイドでない場合は実行しない
    if (isBookingPath || typeof window === 'undefined') return;
  ...
  }, [checkPendingData, isBookingPath]);

  // bookingパスでは何も表示しない
  if (isBookingPath) return null;
